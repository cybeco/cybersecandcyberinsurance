#! Rscript Attackers/Mr/security_portfolio_options.R --

#### SECURITY CONTROL PORFOLIO NODE, MR VERSION ----
...
if (1 %in% techctrl_fwallgways_options |
  ...
  M_security_portfolio_options <- c(1,0)
  ...
  M_security_portfolio_options <- c(0)
} else {
  cat("Error in Mr/security_portfolio_options")
  }