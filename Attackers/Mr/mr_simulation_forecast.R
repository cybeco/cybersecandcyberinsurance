#! Rscript mr simulation_forecast.R --
...
mr_ddos_duration_final <- NULL
for (i in 1:M_portfolios_numberof){
  mr_ddos_duration_final[i] <- cloudReduction(M_portfolios_table$cloud[i],
                                              mr_ddos_duration[i])
...
M_portfolio_simulation_forecast <- data.frame(M_portfolios_table,
                                              mr_num_ddos_attacks,
                                              mr_ddos_duration,
                                              mr_ddos_duration_final,
                                              mr_num_records_exf,
                                              mr_num_business_records_exf,
                                              mr_gain_ddos,
                                              mr_gain_exf_records,
